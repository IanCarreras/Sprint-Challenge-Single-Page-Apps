...
> Answer:  Client-side routing loads the entire website/application on the first request making use of the website/application a faster experience for the user
- [ ] What does AJAX stand for?
> Answer: Asynchronous Javascript and XML
- [ ] What are `controlled components` in React?
> Answer: Controlled components have their values set by React
